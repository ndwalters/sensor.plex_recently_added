...
This has been forked from the original [sensor.plex_recently_added](https://github.com/custom-components/sensor.plex_recently_added) by [maykar](https://github.com/maykar).
...
This component does not require, nor conflict with, the default Plex components.</br>
...
5. Add the URL "https://github.com/ndwalters/sensor.plex_recently_added"
...
1. Install this component by copying [these files](https://github.com/ndwalters/sensor.plex_recently_added/tree/master/custom_components/plex_recently_added) to `custom_components/plex_recently_added/`.
